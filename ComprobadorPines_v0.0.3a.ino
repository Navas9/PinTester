 ...
 * Descripción:       Comprobador de continuidad y conexionado
                      ...
                      código incluye modos de 6 y 10 pines.
...
const char *menuOptions[MENU_SIZE] = {"10-PIN", "6-PIN", "4-PIN"};
int selecOpcion = 0;
